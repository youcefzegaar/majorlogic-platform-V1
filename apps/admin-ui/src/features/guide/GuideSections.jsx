import {
  BrainCircuit, ChevronRight, Circle, Zap, Shield,
  TrendingUp, Eye, GitBranch,
} from 'lucide-react';
import { Step, Tip, Warn, Badge } from './GuideComponents';
...
export const sections = {
  ...
  audit_log: () => (
    <>
      ...
      <Tip>Filter by action type or date range to narrow down what changed before a regression appeared.</Tip>
    </>
  ),
